---
typ: backlog_seed
titel: "Allowlist-Eintrag fehlt für langgraph-redaktionsplan"
...
trigger: coverage-allowlist-fehlt-langgraph-redaktionsplan
...
**Quelle:** check-service-coverage @ 2026-05-27T13:44:28+02:00

**Trigger-Key (Dedup-Anker):** `coverage-allowlist-fehlt-langgraph-redaktionsplan` — solange dieser Seed
`status: offen` trägt, bumpt jeder neue Befund nur `gesehen_am` und
`## Letzter Befund`, kein zweiter Seed wird angelegt.

## Letzter Befund
_(2026-05-27)_ Service langgraph-redaktionsplan ist Klasse A/B in Registry, aber /etc/claude/nightly-allowlist.conf hat keine build-Stelle. registry-apply.sh erneut laufen lassen + sudo-Install des Allowlist-Fragments.
