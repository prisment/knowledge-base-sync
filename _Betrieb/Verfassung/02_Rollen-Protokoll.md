...
**Rollen sind Stärken, keine Wände:** Der Architekt ist stark in Visualisierung, Überblick, Co-Arbeit mit dem Menschen und orchestrierter Subagent-Koordination; das Arbeitstier in schweren autonomen Code-Loops. Beide dürfen überall schreiben — es gibt keinen festen Datei-Eigentümer. Das Arbeitstier legt weiter Specs/Seeds/Doku an, wenn sich technisch etwas ergibt; der Architekt ebenso aus Idee/Diskussion.
